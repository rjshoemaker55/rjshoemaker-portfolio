      ...
      <div className='container main-section'>
        <div className='row'>
          <div className='col-sm-12'>
            ...
            <h3 className='secondary-header'>
              I create beautiful, responsive web applications with backend
              functionality.
            </h3>
          </div>
        </div>
        <div className='row' id='page-link-section'>
          <div className='col-sm-12 col-lg-4'>
            ...
            >
              <div className='page-link'>GitHub</div>
            </a>
          </div>
          <div className='col-sm-12 col-lg-4'>
            <a
              ...
              rel='noopener noreferrer'
            >
              <div className='page-link'>LinkedIn</div>
            </a>
          </div>
          <div className='col-sm-12 col-lg-4'>
            <a
              href={require('../../images/R Shoemaker Resume (for public).pdf')}
              target='_blank'
              rel='noopener noreferrer'
            >
              <div className='page-link'>Résumé</div>
            </a>
          </div>
        </div>
